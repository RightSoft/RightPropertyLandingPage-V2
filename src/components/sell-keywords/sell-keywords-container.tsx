...
export default function SellKeywordsContainer() {
    return <div className="h-[28.125rem] mobile:h-[11.375rem] flex items-center relative"
        style={{ backgroundImage: `linear-gradient(94.44deg, rgba(255, 255, 255, 0.8) 5.42%, rgba(255, 255, 255, 0) 54.55%), url(${featuresBg})`, backgroundSize: 'cover', backgroundRepeat: "no-repeat" }}
    >
        <div
            className="absolute top-0 left-0 w-full h-[7.6775rem] mobile:h-4"
            style={{
                background: "linear-gradient(161.98deg, #FFFFFF 10.85%, rgba(255, 255, 255, 0) 86.33%)",

            }} />
        <div
            className="absolute bottom-0 left-0 w-full h-[7.6775rem] mobile:h-4"
            style={{
