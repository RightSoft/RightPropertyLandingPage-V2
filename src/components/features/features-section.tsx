...
export default function FeaturesSection() {
    ...
    >
        ...
        >
            <SectionTitle text={<div>Powerful <span className="mobile:text-rpBlue">&</span> Effortless</div>} variant="md" className="flex justify-center mobile:text-20" />
            ...
            {width <= 800 &&
                <div className="pb-9"><FeaturesMobileColumn /> </div>
            }
        </div>
    </div>
