...
export default function Footer() {
  ...
  return (
    <footer
      ref={container}
      className=" bg-[#F8F8F9] z-0 relative "
      style={{
        ...
        <div className="mobile:w-full">
          ...
          <div className="mobile:flex justify-between items-center hidden ">
            <div className="flex gap-[0.8125rem] text-[#7BD6E1] ">
              ...
              <a
                href="https://www.instagram.com/rightpropertyapp/"
                target="_blank"
              >
          ...
          <div className="flex gap-[2.53125rem] mobile:hidden">
            <a href="https://twitter.com/ukrightproperty" target="_blank">
              <Twitter className="text-[#525361] w-10" />
            </a>
            <a
              href="https://www.instagram.com/rightpropertyapp/"
              target="_blank"
            >
              <Instagram className="text-[#525361] w-10" />
            </a>
            <a
              href="https://uk.linkedin.com/company/rightpropertyapp"
              target="_blank"
            >
              <Linkedin className="text-[#525361] w-10" />
            </a>
          </div>
        </div>
