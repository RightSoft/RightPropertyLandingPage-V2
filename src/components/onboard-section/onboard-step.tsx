...
export default function OnboardStep({ index, title, description, icon }: OnboardStepProps) {
    return <motion.div
        initial={{ opacity: 0}}
        className="onboard-step text-center w-[23.4375rem] flex flex-col  items-center">
        <div className="h-[7.9375rem] ">
            <div className="text-[#14141A] mb-[0.6875rem]">
                <span className="text-[1.5rem] leading-[1.82875rem]">{title}</span>
            </div>
            <div className="text-[1rem] leading-[1.21875rem] font-light text-[#282936]">
                {description}
            </div>
        </div>
