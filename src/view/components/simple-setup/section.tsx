        ...
        <section className="bg-blue-soft" aria-label="Simple setup process for Right Property platform">
            <div className="rp-container py-[7.5rem] lg:py-[2.5rem] lg:px-6">
                <div className="flex justify-center gap-[8.4375rem]">
                    <img className='w-[36.875rem] h-auto lg:hidden' src={rBlockImage} alt="Right Property simple setup interface demonstration" loading="lazy" decoding="async" />
                    <div>
                        ...
                        <img className='w-full h-auto lg:block hidden mb-[2.5rem]' src={rBlockImage} alt="Right Property simple setup interface demonstration" loading="lazy" decoding="async" />
