        ...
        <div className="lg:bg-[#F5F5F5] lg:h-[42rem]">
            <div className="rp-container lg:pb-[2.25rem]">
                <div className="flex lg:flex-col-reverse gap-[8.4375rem] lg:gap-[2.25rem] items-center justify-center">
                    ...
                    <img className="lg:hidden w-[33.125rem] lg:w-full h-auto lg:px-2" src={seoReadyImage} alt="Fully interactive project website" />
                    <img className="hidden lg:block lg:w-full h-auto lg:px-2" src={seoReadyMobile} alt="Fully interactive project website" />
