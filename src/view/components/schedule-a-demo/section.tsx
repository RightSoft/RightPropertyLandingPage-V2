...
export default function ScheduleADemoSection() {
    return <section className="bg-[#DDF3F8] py-[7.5rem] lg:py-[5rem]" aria-label="Schedule a demo meeting with Right Property team">
        <div className="rp-container mx-auto w-[640px] lg:w-full lg:px-6">
            <div className="inline-block">
                <p className="mb-[0.625rem] font-geist text-base lg:text-14 font-normal leading-[150%] tracking-[0.04em] uppercase">
                    Let's take a seat
                </p>
                <h3 className="mb-10 font-general-sans text-80 lg:text-40 font-semibold leading-[100%] tracking-[0%]">
