export default function PrivacyPolicy() {
  return (
    <div className="privacy  p-5 lg:p-7.5 flex justify-center page-container grow bg-secondLayer">
      <>
        <h3 style={{}}>
          <strong>
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            This Privacy and Cookies Policy relates to our use of any personal
            information we collect from you via the following online services:
          </span>
        </p>
        <ul>
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            to review their policies separately. They will govern the use of
            personal information you submit when visiting those websites, which
            may also be collected by cookies. We do not accept any
            responsibility or liability for the privacy practices of those third
          ...
          <li className="privacy-text-small">
            <p>
              <span className="privacy-text-small">
                ...
                or not you are accessing the services from the UK;
              </span>
            </p>
          </li>
          <li className="privacy-text-small">
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            information you submit on the form.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
          ...
          <a href="mailto:info@rightproperty.app">
            <u>
              <span
                style={{ color: "var(--primary-color-3)", fontSize: "11pt" }}
              >
                info@rightproperty.app
              </span>
            </u>
          </a>
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            protection reasons) or as described in this section and section 9.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            sites (e.g. Meta, Google, MailChimp, credit reference suppliers,
            Instagram, Snapchat and X) some data, with appropriate security
            measures, to show you relevant advertising on third party sites, as
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            strictly with our instructions and Right Property requires that they
            do not use your personal information for their own business
            purposes, unless you have explicitly consented to the use of your
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            including to law enforcement agencies or your internet provider.
            Right Property would only do so in circumstances where such
            disclosure is permitted under applicable laws, including data
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            efforts consistent with our legal duty to supply, correct or delete
            personal information about you in our files. If you are within the
            UK, please address requests and questions about this or any other
            question about this Privacy and Cookies Policy to the Data
            Protection Officer,&nbsp;
          </span>
          <strong>
            <em>
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            computer and is stored on your device’s hard drive. Each website can
            send its own cookie to your web browser if your browser’s
            preferences allow it. Many websites do this whenever a user visits
            their website in order to track online traffic flows. Similar
            technologies are also often used within emails to understand whether
            the email has been read or if any links have been clicked. If you
          ...
          <span className="privacy-text-small">
            ...
            user) has visited the website before. This is done on a repeat visit
            by checking to find and using the cookie left there on the last
            visit.
          </span>
        </p>
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            help improve the services it provides to its users. Certain areas of
            Right Property websites may use cookies for a specific reason.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
          ...
          <span className="privacy-text-small">
            ...
            visit a page containing such content you may be presented with
            cookies from these websites and these third party cookies may track
            your use of Right Property website. Right Property does not control
            the dissemination of these cookies and you should check the relevant
            third party’s website for more information. If you continue without
          ...
          <span className="privacy-text-small">
            ...
            Property does not control this. For more information, see the Google
            webpage “
          </span>
          <a href="https://www.google.com/policies/privacy/partners/">
            <span style={{ color: "var(--primary-color-3)", fontSize: "11pt" }}>
          ...
          <table style={{ border: "none", borderCollapse: "collapse" }}>
            <tbody>
              ...
              <tr className="privacy-text-small">
                ...
                <td style={{ border: "solid #d6d6d6 0.75pt" }}>
                  {
                    "Google Analytics helps measure the website traffic and perform vital analytics tasks. For more information visit Google's Privacy Policy at: https://policies.google.com/privacy. To Opt-Out, visit: https://tools.google.com/dlpage/gaoptout/."
                  }
                </td>
              </tr>
            </tbody>
        ...
        <p style={{}}>
          ...
          <a href="https://www.attacat.co.uk/resources/cookies/how-to-ban">
            <span style={{ color: "var(--primary-color-3)", fontSize: "11pt" }}>
              &nbsp;how
            </span>
          </a>
          ...
          <span className="privacy-text-small">
            ...
            provide some features you have previously chosen to receive.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
          ...
          <span className="privacy-text-small">
            ...
            be possible for you to choose to provide Right Property with access
            to your device’s location through the web-browser. We use
            information provided by your browser or by the link that you have
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            cookie such as by enabling the app to ‘remember’ you or provide you
            with the content you have requested.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            number or app ID (a unique identifier relating to the particular
            copy of the app you are running) may be collected automatically.
          </span>
        </p>
        <p style={{}}>
          <span className="privacy-text-small">
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            we will require you to register with us and provide positive
            acceptance of this Policy. Many of our Applications will not collect
            or use this type of information. Where registration is required if
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            reserve the right to transfer information outside of your country.
          ...
          <span className="privacy-text-small">
            ...
            information we process and maintain, due to the inherent nature of
            the internet and related technology no security system can prevent
        ...
        <p style={{}}>
          ...
          <span className="privacy-text-small">
            ...
            independent privacy policies. We have no responsibility or liability
            for the content and activities of these linked applications,
            however, to protect the integrity of our applications, we welcome
            feedback regarding any breach of privacy policies by those third
            parties.
          </span>
        </p>
        <p style={{}}>
        ...
        <p style={{}}>
          <span className="privacy-text-small">
            ...
            on this page. If you do not agree to these changes, please do not
            continue to use Right Property websites to submit personal
            information to Right Property. If material changes are made to the
            Privacy and Cookies Policy, for instance affecting how we would like
            to use your personal information, we will provide a more prominent
